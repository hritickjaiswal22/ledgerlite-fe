...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn("[&_tr]:border-b", "bg-table-header-bg", className)}
      {...props}
    />
  );
}
  ...
  return (
    <th
      ...
      className={cn(
        ...
        "px-6 py-4 text-xs leading-4 font-semibold text-muted-foreground",
        className,
      )}
      {...props}
    />
  ...
  return (
    <td
      ...
      className={cn(
        ...
        "px-6 py-4 text-body-sm font-mono-data",
        className,
      )}
      {...props}
    />
